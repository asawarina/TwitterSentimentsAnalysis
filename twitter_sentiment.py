...
if __name__ == '__main__':
   ...
   time_positive = pd.Series(df['sentiment'].values, index = df['date'])
   #time_positive.plot(figsize=(16,4), label="likes", legend=True)
   time_positive.plot(figsize=(16,4), color='r')
   plt.show()
